...
<img class="img-logo" src="https://www.freepnglogos.com/uploads/pok-mon-go-logo-png-30.png"/>
    <div class="form-box">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
                <div class="inputs">
                    <input id="date_of_birth" placeholder="Birthday: MM/DD/YYY" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth') }}" required autocomplete="date_of_birth" autofocus>
